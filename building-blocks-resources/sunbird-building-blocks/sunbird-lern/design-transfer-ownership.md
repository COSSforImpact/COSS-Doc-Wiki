...
2. Unique list of ‘createdBy’ users' list will be taken from the combination of the return List/Search API responses from above API calls.
...
![](<../../../.gitbook/assets/grey\_arrow\_down (1).png>)'\{{host\}}/api/user/v1/ownership/transfer'
...
![](<../../../.gitbook/assets/grey\_arrow\_down (1).png>)Response
...
![](<../../../.gitbook/assets/grey\_arrow\_down (1).png>)Sample event
