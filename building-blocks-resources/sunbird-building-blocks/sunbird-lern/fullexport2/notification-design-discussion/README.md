...
**Configuration Restriction** : **Max Batch limit :** MAX\_BATCH\_LIMIT is need to be configured that will be the max ids can be passed in a single notification object.
