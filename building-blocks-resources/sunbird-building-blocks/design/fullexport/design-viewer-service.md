...
The content status and score metrics data should be updated to user\_activity\_agg table from user\_enrolemnts and assessment\_agg table for all the existing enrolment records.
