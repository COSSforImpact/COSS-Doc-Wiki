...
| Indexer         | Transactional | <p>Generic consumer which can sync data for following resources.</p><ul><li>User</li><li>Organisation</li><li>Course Batch</li><li>Location</li></ul> |
