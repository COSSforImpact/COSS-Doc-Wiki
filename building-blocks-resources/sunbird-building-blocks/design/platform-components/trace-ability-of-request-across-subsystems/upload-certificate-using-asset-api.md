...
* [Introduction:](upload-certificate-using-asset-api.md#introduction:)
* [Background:](upload-certificate-using-asset-api.md#background:)
* [Problem Statement:](upload-certificate-using-asset-api.md#problem-statement:)
* [Key design problems:](upload-certificate-using-asset-api.md#key-design-problems:)
* [How to get certificates using asset API](upload-certificate-using-asset-api.md#how-to-get-certificates-using-asset-api)
  * [Curl:](upload-certificate-using-asset-api.md#curl:)
* [How to get default certificate layouts using asset API?](upload-certificate-using-asset-api.md#how-to-get-default-certificate-layouts-using-asset-api?)
* [How to upload/create a new certificate template using a certificate layout(asset) or existing certificate template?](upload-certificate-using-asset-api.md#how-to-upload/create-a-new-certificate-template-using-a-certificate-layout\(asset\)-or-existing-certificate-template?)
* [How to upload/create an asset(used for uploading logos, signatures)](upload-certificate-using-asset-api.md#how-to-upload/create-an-asset\(used-for-uploading-logos,-signatures\))
* [How to copy & use the existing certificate template](upload-certificate-using-asset-api.md#how-to-copy-&-use-the-existing-certificate-template)
* [How to get asset details(for do\_id)](upload-certificate-using-asset-api.md#how-to-get-asset-details\(for-do\_id\))
...
**Create API (logo/signature create to get do\_Id)** _API endpoint:_
...
**Create API (logo/signature create to get do\_Id)**
...
### How to get asset details(for do\_id)

This is to get the details of the asset/certificate by using do\_id
