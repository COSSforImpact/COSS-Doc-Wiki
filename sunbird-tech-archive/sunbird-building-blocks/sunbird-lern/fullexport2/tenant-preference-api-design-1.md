...
#### `POST v2/org/preferences/create` <a href="#tenantpreferenceapidesign-postv2-org-preferences-create" id="tenantpreferenceapidesign-postv2-org-preferences-create"></a>
