...
* if  api return values is {locked:true} user details will be fetched and error popup will be shown with user name in the popup as shown below.![](<images/storage/Screen Shot 2018-09-21 at 6.48.52 PM.png>)
...
![](<images/storage/locking\_journey (2).png>)

![](<images/storage/heartbeat (3).png>)

&#x20;                                                                                            &#x20;

![](<images/storage/offline\_handling (1).png>)
